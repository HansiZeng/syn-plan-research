...
set -e
# dataset_names=("gaia" "webwalker" "gpqa" "2wikimultihopqa" "bamboogle" "hotpotqa" "musique")
# splits=("dev" "test" "diamond" "test" "test" "test" "test")
# dataset_names=("gaia" "webwalker" "bamboogle" "musique")
# splits=("dev" "test" "test" "test")
# dataset_names=("gaia" "webwalker" "bamboogle")
# splits=("dev" "test" "test")
...
for i in "${!pass_at_ks[@]}"; do
    ...
    cmd=(
        python web_research/run_web_research_chat_tool_plan.py
