...
from verl.utils.reward_score import web_research_qa_f1_format
from verl.workers.reward_manager import register


@register("format_naive")
class FormatNaiveRewardManager:
    """The reward manager."""

    def __init__(self, tokenizer, num_examine, compute_score=None, reward_fn_key="data_source", format_score=0.2) -> None:
        """
        Initialize the FormatNaiveRewardManager instance.
        ...
        self.compute_score = web_research_qa_f1_format.compute_score 
        self.reward_fn_key = reward_fn_key  # Store the key for accessing the data source
        self.format_score = format_score  # Coefficient for format reward

        print("🔧 [DEBUG] successfully initialized FormatNaiveRewardManager with format_score:", self.format_score)
