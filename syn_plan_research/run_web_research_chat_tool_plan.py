...
from diverse_prompts import build_prompt_factory
...
async def main_async(args):
    ...
    agent = AsyncWebResearchChatAgent(
        ...
        build_prompt=build_prompt_factory(
    ...
    result_json_name = f"diverse_prompt_minstep_{args.min_steps}_maxstep_{args.max_steps}-{result_json_name}"
