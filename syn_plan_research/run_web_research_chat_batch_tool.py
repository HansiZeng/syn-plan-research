...
from prompts import prompt_react_map
...
def main():
    ...
    parser.add_argument("--web_search_context_chars", type=int, default=200, help="Context characters for web search results")
    parser.add_argument("--context_chars", type=int, default=2000, help="Context characters for web search results")
    parser.add_argument
